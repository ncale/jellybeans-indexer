export const JellyBeansAbi = [
  ...
  { inputs: [], name: "FailedToSendFees", type: "error" },
  { inputs: [], name: "IncorrectFeeAmount", type: "error" },
  { inputs: [], name: "NoFeesToWithdraw", type: "error" },
  { inputs: [], name: "ReentrancyGuardReentrantCall", type: "error" },
  { inputs: [], name: "RoundAlreadyFinalized", type: "error" },
  { inputs: [], name: "RoundDoesNotExist", type: "error" },
  { inputs: [], name: "SubmissionDeadlineNotInFuture", type: "error" },
  { inputs: [], name: "SubmissionDeadlineNotPassed", type: "error" },
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        ...
        indexed: false,
        internalType: "struct Jellybeans.Submission[]",
        name: "winners",
        type: "tuple[]",
      },
      {
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256", name: "_numWinners", type: "uint256" },
